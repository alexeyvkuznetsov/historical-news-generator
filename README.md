...
### Целевая аудитория (приект исключительно развлекательный)
...
Проект может быть интересен образовательным платформам, историческим пабликам, музеям (как интерактивный экспонат), а также как независимый развлекательный веб-сервис.
