...
st.caption("Сочинитель лже-историческихъ вѣстей съ примѣненіемъ Разума Механическаго (LLM). Сотворёнъ во время прохожденія курса учебнаго ['Дѣлаемъ свой AI-продуктъ на базѣ ChatGPT или другихъ LLM моделей'](https://stepik.org/course/178846/).")
